...
session_id($_POST['sesId']);        // получам сохраненное значение $_POST['sesId'] которое равно результату return document.getElementById('ses').innerHTML;, в тесте которого записан id ссесии
print_r($_POST['sesId']);
session_start();
...
function Dom_session() {
    if(isset($_POST['param'])) {
       ...
       echo '<span id="ses" style="display:block">'.session_id().'</span>';      // считать
    }
}
function Massiv() {
// 1. ####################################################################################
